...
multi-country catalog before the user asks for one. The route screen network
picker can then load the Transitland coverage collection or smaller country and
